...
* Rescale height scores to metres. When numunitid is not $\in{173, 432, 3202}$, which correspond to metres, the height measurement is divided by 100. All other measurements are assumed to be in centimetres. **LOOK AT THIS**.
...
* All measurements are assumed to be in the correct unit of measurement. **LOOK AT THIS**.
